## cascade_lifecycle (lyrical) - 2.0.6-1

The packages in the `cascade_lifecycle` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro lyrical` on `Tue, 28 Jul 2026 10:28:13 -0000`
...
## cascade_lifecycle (lyrical) - 2.0.4-4

The packages in the `cascade_lifecycle` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro lyrical` on `Tue, 28 Jul 2026 09:19:38 -0000`
...
## cascade_lifecycle (kilted) - 2.0.4-1

The packages in the `cascade_lifecycle` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted cascade_lifecycle` on `Thu, 16 Oct 2025 05:45:56 -0000`
...
## cascade_lifecycle (rolling) - 2.0.4-1

The packages in the `cascade_lifecycle` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling cascade_lifecycle` on `Fri, 06 Jun 2025 05:28:38 -0000`
...
## cascade_lifecycle (rolling) - 2.0.0-1

The packages in the `cascade_lifecycle` repository were released into the `rolling` distro by running `/usr/local/bin/bloom-release cascade_lifecycle --rosdistro rolling` on `Thu, 04 Apr 2024 05:36:46 -0000`
...
## cascade_lifecycle (iron) - 1.0.4-1

The packages in the `cascade_lifecycle` repository were released into the `iron` distro by running `/usr/local/bin/bloom-release --edit cascade_lifecycle --rosdistro iron` on `Sat, 15 Jul 2023 06:11:27 -0000`
...
## cascade_lifecycle (rolling) - 1.0.3-1

The packages in the `cascade_lifecycle` repository were released into the `rolling` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro rolling` on `Sat, 31 Dec 2022 06:46:40 -0000`
...
## cascade_lifecycle (humble) - 1.0.2-1

The packages in the `cascade_lifecycle` repository were released into the `humble` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro humble` on `Sat, 31 Dec 2022 06:16:15 -0000`
...
## cascade_lifecycle (humble) - 1.0.1-1

The packages in the `cascade_lifecycle` repository were released into the `humble` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro humble` on `Thu, 26 May 2022 10:50:59 -0000`
...
## cascade_lifecycle (galactic) - 1.0.0-2

The packages in the `cascade_lifecycle` repository were released into the `galactic` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro galactic` on `Sat, 03 Jul 2021 16:53:11 -0000`
...
## cascade_lifecycle (galactic) - 1.0.0-1

The packages in the `cascade_lifecycle` repository were released into the `galactic` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro galactic` on `Sat, 03 Jul 2021 16:45:36 -0000`
...
## cascade_lifecycle (foxy) - 0.0.7-3

The packages in the `cascade_lifecycle` repository were released into the `foxy` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro foxy` on `Fri, 12 Mar 2021 06:43:03 -0000`
...
## cascade_lifecycle (foxy) - 0.0.7-2

The packages in the `cascade_lifecycle` repository were released into the `foxy` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro foxy` on `Fri, 12 Mar 2021 06:35:20 -0000`
...
## cascade_lifecycle (foxy) - 0.0.7-1

The packages in the `cascade_lifecycle` repository were released into the `foxy` distro by running `/usr/bin/bloom-release cascade_lifecycle --rosdistro foxy` on `Fri, 12 Mar 2021 06:33:20 -0000`
...
## cascade_lifecycle (foxy) - 0.0.6-1
